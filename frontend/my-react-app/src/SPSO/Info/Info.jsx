    ...
    <div className="parent-info-container">
      <div className="info-container">
        <div className="info-header">
          {/* Avatar */}
          <div alt="Avatar" className="info-avatar" />

          {/* About Me Content */}
          <div className="info-details">
            <h1>About Me</h1>
            <p className="info-role">A Lead UX & UI designer based in Canada</p>
            <p className="info-description">
              I <span className="highlight">design and develop</span> services
              for customers of all sizes, specializing in creating stylish,
            ...
            <div className="info-personal">
              <div>
                <p>
                  <strong className="olala">Full Name:</strong>{" "}
                  {userData.full_name || "Loading..."}
                </p>
                <p>
                  <strong className="olala">E-mail:</strong>{" "}
                  {userData.email || "Loading..."}
                </p>
              </div>
              <div>
                <p>
                  <strong className="olala">Phone:</strong>{" "}
